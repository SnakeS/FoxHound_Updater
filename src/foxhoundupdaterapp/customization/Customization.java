package foxhoundupdaterapp.customization;
...
public class Customization {
    ...
    //DownloadDirectory
    public static final String DOWNLOAD_DIR = "FoxHound_Updates";
    //MUST be the first package name.
    public static final String PACKAGE_FIRST_NAME = "foxhoundupdaterapp";
